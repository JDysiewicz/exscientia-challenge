...
- **Browser compatibility**: A full browser compatability check has not been done to ensure all styling/functionality remains consistent across browsers, and so small styling bugs are expected depending on the browser used.
